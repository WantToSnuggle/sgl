...
int main(int argc, char *argv[])
{
    ...
    // sgl_obj_set_pos(ring, 300, 200);
    // sgl_obj_set_size(ring, 200, 200);
    // sgl_obj_set_style(ring, SGL_STYLE_RADIUS, 80);
    // sgl_obj_set_style(ring, SGL_STYLE_RING_WIDTH, 40);
    ...
    sgl_obj_set_style(arc, SGL_STYLE_ARC_START_ANGLE, 40);
    sgl_obj_set_style(arc, SGL_STYLE_ARC_END_ANGLE, 320);
    sgl_obj_set_style(arc, SGL_STYLE_ARC_MODE, SGL_DRAW_ARC_ROUND);
    ...
    sgl_obj_set_style(label2, SGL_STYLE_TEXT, SGL_TEXT("H:0%"));
